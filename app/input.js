...
var keyCodes = {
    left: 37, right: 39, up: 38, down: 40, A: 90, B: 88, start: 27
};

// WASD configuration
var keyCodesAlt = {
    left: 65, right: 68, up: 87, down: 83, A: 75, B: 76, start: 13
};
...
document.getElementById("up").addEventListener('touchstart', function (e) { input.up = true; }, false);
document.getElementById("up").addEventListener('touchend', function (e) { input.up = false; }, false);
